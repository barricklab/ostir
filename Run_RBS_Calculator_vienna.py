...
def main(input_args):
    ...
    print(seq)
    calcObj = RBS_Calculator(seq, start_range, rRNA, constraints_str)
    exit()
    calcObj.calc_dG()
...
def Run_RBS_Calculator(sequence, start_pos=None):
    input_args = ['First value doesnt matter',
                  sequence]
    if start_pos:
        input_args.append(start_pos)
    main(input_args)
    return
