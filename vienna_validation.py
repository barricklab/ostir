...
def generate_validation_table(): # Anderson RBS family - https://parts.igem.org/Ribosome_Binding_Sites/Prokaryotic/Constitutive/Anderson
    RNAs = [
