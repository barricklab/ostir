...
if __name__ == "__main__":
    ...
    if hasattr(options, 'd'):
        cmd_kwargs['detailed_out'] = options.d
    if hasattr(options, 'o'):
        cmd_kwargs['outfile'] = options.o
    if hasattr(options, 'v'):
        cmd_kwargs['verbose'] = options.v
    if hasattr(options, 's'):
        cmd_kwargs['start_loc'] = options.s
    if hasattr(options, 'e'):
        cmd_kwargs['end_loc'] = options.e

    output = RBS_Calculator_Vienna(**cmd_kwargs)
